...
THEMES.Nature = {
    Name           = "Nature",
    BackdropTop    = Color3.fromRGB(238, 241, 239),
    BackdropBottom = Color3.fromRGB(248, 250, 248),
    BackdropT      = 0.0,
    Primary        = Color3.fromRGB(250, 251, 250),
    PrimaryLight   = Color3.fromRGB(255, 255, 255),
    Secondary      = Color3.fromRGB(246, 248, 246),
    SecondaryLight = Color3.fromRGB(238, 242, 239),
    PanelTop       = Color3.fromRGB(252, 253, 252),
    PanelBottom    = Color3.fromRGB(232, 236, 233),
    PanelT         = 0.04,
    PanelTopT      = 0.02,
    PanelBottomT   = 0.10,
    ControlT       = 0.10,
    ControlTopT    = 0.04,
    ControlBottomT = 0.16,
    Accent         = Color3.fromRGB(78, 186, 108),
    AccentTop      = Color3.fromRGB(102, 207, 132),
    AccentBottom   = Color3.fromRGB(62, 164, 92),
    AccentDim      = Color3.fromRGB(147, 216, 166),
    AccentText     = Color3.fromRGB(255, 255, 255),
    Text           = Color3.fromRGB(28, 38, 32),
    TextDim        = Color3.fromRGB(82, 94, 86),
    TextMuted      = Color3.fromRGB(142, 151, 145),
    Border         = Color3.fromRGB(210, 217, 212),
    BorderGlow     = Color3.fromRGB(255, 255, 255),
    ToggleOff      = Color3.fromRGB(211, 216, 212),
    ToggleThumb    = Color3.fromRGB(255, 255, 255),
}

THEMES.Apple = {
    Name           = "Apple",
    BackdropTop    = Color3.fromRGB(235, 237, 242),
    BackdropBottom = Color3.fromRGB(248, 249, 251),
    BackdropT      = 0.0,
    Primary        = Color3.fromRGB(250, 251, 253),
    PrimaryLight   = Color3.fromRGB(255, 255, 255),
    Secondary      = Color3.fromRGB(246, 247, 250),
    SecondaryLight = Color3.fromRGB(237, 239, 244),
    PanelTop       = Color3.fromRGB(252, 253, 255),
    PanelBottom    = Color3.fromRGB(232, 235, 241),
    PanelT         = 0.04,
    PanelTopT      = 0.02,
    PanelBottomT   = 0.10,
    ControlT       = 0.10,
    ...
    TextDim        = Color3.fromRGB(88, 89, 94),
    TextMuted      = Color3.fromRGB(145, 146, 151),
    Border         = Color3.fromRGB(210, 213, 220),
    BorderGlow     = Color3.fromRGB(255, 255, 255),
    ToggleOff      = Color3.fromRGB(213, 216, 222),
    ToggleThumb    = Color3.fromRGB(255, 255, 255),
}

THEMES.Galaxy = {
    Name           = "Galaxy",
    BackdropTop    = Color3.fromRGB(238, 236, 245),
    BackdropBottom = Color3.fromRGB(249, 248, 252),
    BackdropT      = 0.0,
    Primary        = Color3.fromRGB(251, 250, 254),
    PrimaryLight   = Color3.fromRGB(255, 255, 255),
    Secondary      = Color3.fromRGB(247, 246, 251),
    SecondaryLight = Color3.fromRGB(239, 237, 246),
    PanelTop       = Color3.fromRGB(253, 252, 255),
    PanelBottom    = Color3.fromRGB(234, 231, 242),
    PanelT         = 0.04,
    PanelTopT      = 0.02,
    PanelBottomT   = 0.10,
    ControlT       = 0.10,
    ControlTopT    = 0.04,
    ControlBottomT = 0.16,
    Accent         = Color3.fromRGB(141, 92, 246),
    AccentTop      = Color3.fromRGB(166, 121, 255),
    AccentBottom   = Color3.fromRGB(116, 72, 226),
    AccentDim      = Color3.fromRGB(190, 164, 255),
    AccentText     = Color3.fromRGB(255, 255, 255),
    Text           = Color3.fromRGB(33, 29, 42),
    TextDim        = Color3.fromRGB(89, 83, 103),
    TextMuted      = Color3.fromRGB(148, 143, 158),
    Border         = Color3.fromRGB(214, 210, 224),
    BorderGlow     = Color3.fromRGB(255, 255, 255),
    ToggleOff      = Color3.fromRGB(216, 213, 224),
    ToggleThumb    = Color3.fromRGB(255, 255, 255),
}
